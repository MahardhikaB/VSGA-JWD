        ...
        <div class="col">
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nrp" name="Nim" value="<?= $mahasiswa['nim']?>">
                </div>
                <div class="form-group">
                ...
                <div class="text-right">
                    <button type="submit" name="submit" class="btn btn-primary text-center">Ubah Data</button>
                </div>
            </form>
        </div>
    </div>
